...
/** @type {string} */
const CACHE_VERSION = '1761182252|797464776';
/** @type {string} */
const CACHE_PREFIX = 'sml_CP10-v1.0-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'cp10-1.0.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["cp10-1.0.html","cp10-1.0.js","cp10-1.0.offline.html","cp10-1.0.icon.png","cp10-1.0.apple-touch-icon.png","cp10-1.0.audio.worklet.js","cp10-1.0.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["cp10-1.0.wasm","cp10-1.0.pck"];
