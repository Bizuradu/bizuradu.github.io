...
/** @type {string} */
const CACHE_VERSION = '1753401111|29106010788';
/** @type {string} */
const CACHE_PREFIX = 'sml_CP10-v0.3.1-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'cp10-0.3.1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["cp10-0.3.1.html","cp10-0.3.1.js","cp10-0.3.1.offline.html","cp10-0.3.1.icon.png","cp10-0.3.1.apple-touch-icon.png","cp10-0.3.1.audio.worklet.js","cp10-0.3.1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["cp10-0.3.1.wasm","cp10-0.3.1.pck"];
