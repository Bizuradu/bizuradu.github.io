...
/** @type {string} */
const CACHE_VERSION = '1754354152|28068244467';
/** @type {string} */
const CACHE_PREFIX = 'sml_CP10-v0.3.2-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'cp10-0.3.2.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["cp10-0.3.2.html","cp10-0.3.2.js","cp10-0.3.2.offline.html","cp10-0.3.2.icon.png","cp10-0.3.2.apple-touch-icon.png","cp10-0.3.2.audio.worklet.js","cp10-0.3.2.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["cp10-0.3.2.wasm","cp10-0.3.2.pck"];
